...
const NANDHI_HILLS_ENDPOINT = PLANT_ENDPOINTS.NandhiHills.endpoint

export const nandhiHillsAPI = {
  /**
   * Get dashboard data for Nandhi Hills plant
   * @returns {Promise<Object>} Dashboard data
   */
  async getDashboardData() {
    try {
      const response = await apiHelpers.get(NANDHI_HILLS_ENDPOINT, {
  ...
  async updateLineStatus(lineId, status) {
    try {
      const response = await apiHelpers.post(NANDHI_HILLS_ENDPOINT, {
