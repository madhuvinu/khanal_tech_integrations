...
const CHAMPAWATH_ENDPOINT = PLANT_ENDPOINTS.Champawath.endpoint

export const champawathAPI = {
  /**
   * Get dashboard data for Champawath plant
   * @returns {Promise<Object>} Dashboard data
   */
  async getDashboardData() {
    try {
      const response = await apiHelpers.get(CHAMPAWATH_ENDPOINT, {
  ...
  async updateLineStatus(lineId, status) {
    try {
      const response = await apiHelpers.post(CHAMPAWATH_ENDPOINT, {
