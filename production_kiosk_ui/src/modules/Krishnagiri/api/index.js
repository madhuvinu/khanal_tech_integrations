...
const KRISHNAGIRI_ENDPOINT = PLANT_ENDPOINTS.Krishnagiri.endpoint

export const krishnagiriAPI = {
  /**
   * Get dashboard data for Krishnagiri plant
   * @returns {Promise<Object>} Dashboard data
   */
  async getDashboardData() {
    try {
      const response = await apiHelpers.get(KRISHNAGIRI_ENDPOINT, {
  ...
  async updateLineStatus(lineId, status) {
    try {
      const response = await apiHelpers.post(KRISHNAGIRI_ENDPOINT, {
