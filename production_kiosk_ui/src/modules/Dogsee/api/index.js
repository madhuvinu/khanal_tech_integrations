...
const DOGSEE_ENDPOINT = PLANT_ENDPOINTS.Dogsee.endpoint

export const dogseeAPI = {
  /**
   * Get dashboard data for Dogsee plant
   * @returns {Promise<Object>} Dashboard data
   */
  async getDashboardData() {
    try {
      const response = await apiHelpers.get(DOGSEE_ENDPOINT, {
  ...
  async updateLineStatus(lineId, status) {
    try {
      const response = await apiHelpers.post(DOGSEE_ENDPOINT, {
