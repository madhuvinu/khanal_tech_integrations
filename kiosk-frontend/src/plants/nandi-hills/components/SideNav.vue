      ...
      <div class="p-4 border-b border-gray-200">
        <div class="flex items-center space-x-3">
          ...
          <div v-if="!isCollapsed" class="flex-1 min-w-0">
            <h2 class="text-sm font-semibold text-gray-900 truncate">Nandi Hills</h2>
            <p class="text-xs text-gray-500 truncate">Secondary Production</p>
          </div>
        </div>
      </div>
...
// Navigation items for Nandi Hills
...
const currentPageTitle = computed(() => {
  ...
  return currentItem ? currentItem.name : 'Nandi Hills Plant'
})
