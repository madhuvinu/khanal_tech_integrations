...
onMounted(async () => {
  ...
  // Log page view
  await activityLogger.logPageView(`/plant/${plantId.value}/${feature.value}`)
  
  // Start page tracking
  activityLogger.startPageTracking(`/plant/${plantId.value}/${feature.value}`)
  
  // Log feature access
  await activityLogger.logUserAction('feature_access', {
