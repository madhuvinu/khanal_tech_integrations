/**
 * Champavath Plant Production Service
 * Plant-specific Production operations for Champavath
 */
...
export class ChampavathProductionService extends BaseAPIService {
  constructor() {
    super('ChampavathProductionService')
    this.plantId = 'champavath'
    this.config = config
  }
  ...
  /**
   * Create pre-production order with Champavath-specific validation
  ...
  async createPreProduction(crateDetails, processType, employeeCount, userEmail) {
    ...
    // Champavath-specific validation
...
export const champavathProductionService = new ChampavathProductionService()

export default champavathProductionService
