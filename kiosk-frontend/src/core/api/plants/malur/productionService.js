/**
 * Malur Plant Production Service
 * Plant-specific Production operations for Malur
 */
...
export class MalurProductionService extends BaseAPIService {
  constructor() {
    super('MalurProductionService')
    this.plantId = 'malur'
    this.config = config
  }
  ...
  /**
   * Create pre-production order with Malur-specific validation
...
export const malurProductionService = new MalurProductionService()

export default malurProductionService
