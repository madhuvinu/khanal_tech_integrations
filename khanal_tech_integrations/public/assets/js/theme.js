...
var PercentageStiil_in_SalesOrder = $('#PercentageStiil_in_SalesOrder').html()
var PercentageDeliveryNotes = $('#PercentageDeliveryNotes').html()
var PercentageInvComplete = $('#PercentageInvComplete').html()
    ...
    var getDefaultOptions = function getDefaultOptions() {
      return {
        ...
        series: [{
          ...
          data: [{
            value: PercentageDeliveryNotes,
            name: 'Stiil in DeliveryNotes'
          }, {
            value: PercentageStiil_in_SalesOrder,
            name: 'Stiil in SalesOrder'
          }, {
            value: PercentageInvComplete,
            name: 'Invoice'
          }]
        }]
      };
