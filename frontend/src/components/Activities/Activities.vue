...
const all_activities = createResource({
  url: 'khanal_tech_integrations.api.activities.get_activities',
...
const whatsappMessages = createResource({
  url: 'khanal_tech_integrations.api.whatsapp.get_whatsapp_messages',
...
function sendTemplate(template) {
  ...
  createResource({
    url: 'khanal_tech_integrations.api.whatsapp.send_whatsapp_template',
    params: {
      reference_doctype: props.doctype,
      reference_name: doc.value.data.name,
