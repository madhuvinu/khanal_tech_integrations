<template>
  ...
  const sections = createResource({
    url: 'khanal_tech_integrations.api.layout.get_fields_layout',
    ...
    createLead.submit(lead, {
      validate() {
        ...
        if (!lead.customer_type) {
          error.value = __('Customer Type')
          return error.value
        }
        if (!lead.custom_sap_customer_code) {
          error.value = __('Sap Customer Code')
          return error.value
        }
        if (!lead.customer_group) {
          error.value = __('Group Code')
          return error.value
        }
